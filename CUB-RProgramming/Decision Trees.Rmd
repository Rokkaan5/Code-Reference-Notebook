...
Let's take a look at what this algorithm does on the `Boston Housing` data set. This dataset contains information collected by the U.S Census Service concerning housing in the area of Boston, MA in the 1970s.
...
library(gridExtra)
grid.arrange(true_f_plot, p, nrow=1)    #true_f_plot = true; p = predicted
```
...
## Other Classification Methods/Algorithms - Machine Learning Course
