...
However, knowing which selector can be quite complicated. To demonstrate this we will try to extract the **recipe name**, **total preparation time**, and **list of ingredients** from [this](http://www.foodnetwork.com/recipes/alton-brown/guacamole-recipe-1940609) guacamole recipe. 
...
[SelectorGadget](http://selectorgadget.com/) is piece of software that allows you to interactively determine what css selector you need to extract specific components from the web page. 
