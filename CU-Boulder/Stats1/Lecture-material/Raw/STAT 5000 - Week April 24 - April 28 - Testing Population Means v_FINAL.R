...
#Base R does not have a function for z.test for means so
...
#***********************************************************************
#Example 2: One-sample, two-sided test for population mean (IQ Scores)
...
#******************************************************************************
#Example 1: One-sample, one-sample test of population mean
...
#*************************************************************************
#Example 2 One-Sample, one-sided test of a population mean
