...
```{r}
Record_3D_DF_all<-read.csv("../../data_files/ClusterSmall3DDataset.csv")
...
SmallCorpus <- Corpus(DirSource("../../data_files/Corpus"))  #JK Note: changed "SmallCorpus" to "Corpus"
...
Next, load in the documents ( from the corpus)
```{r}
NovelCorpus <- Corpus(DirSource("../../data_files/Novels_Corpus"))
(getTransformations()) ## These work with library tm
