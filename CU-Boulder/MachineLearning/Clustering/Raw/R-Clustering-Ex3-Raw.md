---
layout: page
title: "Gates Cluster-Ex3 Raw-code-R"
permalink: /CUB-ML/Raw/Cluster-Example3-R
---

# Cluster (Example3) in R - Dr. Gates' full, raw (unedited) code
...
This data works on a corpus of novels, but can be updated to work on other text or record data."
