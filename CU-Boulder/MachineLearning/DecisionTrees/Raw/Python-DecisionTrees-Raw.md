---
layout: page
title: "Gates Decision Trees Raw-code-Python"
permalink: /CUB-ML/Raw/DecisionTrees-Python
---

# Decision Trees (and other supervised learning) in Python - Dr. Gates' full, raw (unedited) code
